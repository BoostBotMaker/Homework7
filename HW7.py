...
def birthyear_nationality_search(age, country, cur, conn):
    ...
    cur.execute(""" SELECT name, nationality, birthyear
                    FROM Players WHERE nationality = (?)
                """, (country,))
    player_nat = cur.fetchall()
    for player in player_nat:
